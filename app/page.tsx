			...
			<div className='items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0'>
				...
				<div className='prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2'>
					<p>
						...
						I use <strong className='bg-gray-100 dark:bg-gray-800 text-emerald-600 px-1 p-1 rounded font-mono text-sm'>Debian</strong> as my primary and <strong className='bg-gray-100 dark:bg-gray-800 text-red-600 px-1 p-1 rounded font-mono text-sm'>RHEL</strong> as my secondary OS, and I work with <strong className='bg-gray-100 dark:bg-gray-800 text-cyan-600 px-1 p-1 rounded font-mono text-sm'>Golang</strong>, <strong className='bg-gray-100 dark:bg-gray-800 text-orange-600 px-1 p-1 rounded font-mono text-sm'>Rust</strong>, and <strong className='bg-gray-100 dark:bg-gray-800 text-gray-300 px-1 p-1 rounded font-mono text-sm'>Sliver</strong>.
